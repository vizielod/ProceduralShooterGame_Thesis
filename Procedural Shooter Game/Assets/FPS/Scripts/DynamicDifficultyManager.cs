...
namespace Unity.FPS
{
    public class DynamicDifficultyManager : MonoBehaviour
    {
        ...
        private float NormalizedHardDifficultyGaugeTimer = 0f;
        private float NormalizedMediumToHardDifficultyGaugeTimer = 0f;
        private float NormalizedEasyToMediumDifficultyGaugeTimer = 0f;
        private float NormalizedEasyDifficultyGaugeTimer = 0f;
        ...
        void Update()
        {
            ...
            if (objectiveExtractData.targetRemaining == 0 && !objectiveExtractData.playerPerformanceNormalized)
            {
                ...
                /*objectiveExtractData.HardDifficultyGaugeTimer = HardDifficultyGaugeTimer;
                objectiveExtractData.MediumToHardDifficultyGaugeTimer = MediumToHardDifficultyGaugeTimer;
                objectiveExtractData.EasyToMediumDifficultyGaugeTimer = EasyToMediumDifficultyGaugeTimer;
                objectiveExtractData.EasyDifficultyGaugeTimer = EasyDifficultyGaugeTimer;*/
                
                objectiveExtractData.NormalizedHardDifficultyGaugeTimer = NormalizedHardDifficultyGaugeTimer;
                objectiveExtractData.NormalizedMediumToHardDifficultyGaugeTimer = NormalizedMediumToHardDifficultyGaugeTimer;
                objectiveExtractData.NormalizedEasyToMediumDifficultyGaugeTimer = NormalizedEasyToMediumDifficultyGaugeTimer;
                objectiveExtractData.NormalizedEasyDifficultyGaugeTimer = NormalizedEasyDifficultyGaugeTimer;
                
                objectiveExtractData.playerPerformanceNormalized = true;
