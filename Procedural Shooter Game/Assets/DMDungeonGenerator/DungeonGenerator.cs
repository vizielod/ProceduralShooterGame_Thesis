        ...
        private void OnDrawGizmos() {
            ...
            if(drawGlobalVoxels) {
                ...
                foreach(var i in GlobalVoxelGrid) {
                    Gizmos.DrawWireCube(i.Key, Vector3.one * voxelScale); //Originally Size only Vector3.one
                }
            }
            ...
            if(drawAllDoors) {
                ...
                for(int i = 0; i < AllDoorsData.Count; i++) {
                    Gizmos.DrawWireCube(AllDoorsData[i].position, Vector3.one * voxelScale); //Originally Size only Vector3.one
                }
            }
